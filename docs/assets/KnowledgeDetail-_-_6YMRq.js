import{_ as f,o as k,a as o,c as n,b as s,t as r,u as $,e as c,g as b}from"./index-BxxTwxZL.js";import{k as h}from"./index-DROnT6nw.js";const w={class:"article-detail"},y={key:0,class:"state-box"},B={key:1,class:"state-box"},T={class:"error-text"},x={key:2,class:"article-card"},D={class:"article-header"},M={class:"article-icon"},A={class:"article-meta"},G=["innerHTML"],q={__name:"KnowledgeDetail",setup(C){const p=$(),u=c(!0),d=c(null),a=c({title:"加载中...",views:0,content:""}),v=t=>t>=1e4?(t/1e4).toFixed(1)+"万":String(t||0),_=t=>{if(!t||typeof t!="string")return"";let e=t.replace(/^### (.+)$/gm,"<h4>$1</h4>").replace(/^## (.+)$/gm,"<h3>$1</h3>").replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/\*(.+?)\*/g,"<em>$1</em>").replace(/^- (.+)$/gm,"<li>$1</li>").replace(/^\|(.+)\|$/gm,l=>{const g=l.split("|").filter(i=>i.trim());return g.length>=2?'<div class="data-row"><span>'+g.map(i=>i.trim()).join("</span><span>")+"</span></div>":l}).replace(/^\|[-| ]+\|$/gm,"").replace(/^\* (.+)$/gm,"<blockquote>$1</blockquote>").replace(/\n\n/g,"</p><p>").replace(/\n/g,"<br>");return e=e.replace(/(<li>.*?<\/li>)/gs,l=>l.includes("</ul>")?l:"<ul>"+l+"</ul>"),e=e.replace(/<p><\/p>/g,""),e=e.replace(/<p><br><\/p>/g,""),"<p>"+e+"</p>"},m=b(()=>_(a.value.content));return k(async()=>{try{const t=await h.getDetail(p.params.id);t.code===200&&t.data?a.value=t.data:a.value={title:"文章不存在",author:"",views:0,content:"抱歉，您访问的文章不存在。"}}catch{const l={klg_043:{id:"klg_043",title:"抖音金黄桶装酱酒是真老酒吗？新国标说清楚了",author:"酱香荟",icon:"🛢️",views:5800,content:`最近很多酒友私信：抖音上透明塑料桶装的酱香酒，颜色金黄透亮，看着像陈年老酒，这种黄是自然的，还是加了东西？
